...
async function buildMorningBriefEmbed() {
  ...
  console.log('[Brief] newsResult:', newsResult.status, newsResult.status === 'rejected' ? newsResult.reason?.message : `keys=${newsResult.value ? Object.keys(newsResult.value).join(',') : 'null'}`);
